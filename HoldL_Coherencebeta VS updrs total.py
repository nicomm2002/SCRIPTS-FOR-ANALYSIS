...
# Bandas de frecuencia que estamos analizando
BANDS_FREQS = {
    'beta': (13, 30),
    'gamma': (30, 100) 
}
...
def main_analysis():
    ...
    TASK_TO_ANALYZE = 'HoldL' 

    # *** MODIFICACIÓN PRINCIPAL: Ruta de salida de las figuras directamente especificada ***
    global OUTPUT_PLOTS_DIR
    OUTPUT_PLOTS_DIR = Path(r"C:\Users\usuario\Desktop\MATLAB DRIVE\Coherence vs UPDRS\FIGURAS\Coherence_Beta - HoldL")
